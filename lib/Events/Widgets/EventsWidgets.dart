...
//const Text("Loading");
  ...
  static Widget eventsMainScreenName(context, int index,
      ...
      children: [
        ...
        Container(
            ...
            MediaQuery
                ...
                .width - Variables.firstColumnWidth,
            child: ElevatedButton(
              style: (event.id == States.eventPressed) ? ButtonStyles
                  .headerButtonStyle : ButtonStyles.usersListButtonStyle,
              onPressed: () async {
